									...
									<div class="card-body pt-9 pb-0">
													...
													<div class="d-flex flex-column">
														...
														<div class="d-flex flex-wrap fw-bold fs-6 mb-4 pe-2">
															<a href="#" class="d-flex align-items-center text-gray-400 text-hover-primary me-5 mb-2">
																...
																<!--end::Svg Icon-->Sheba Automation Ltd</a>
																<a href="#" class="d-flex align-items-center text-gray-400 text-hover-primary me-5 mb-2">
										...
										<div class="d-flex overflow-auto h-55px">
											<ul class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bolder flex-nowrap">
												<!--begin::Nav item-->
												<li class="nav-item">
													<a class="nav-link text-active-primary me-6 active" href="{{route('admin.overview')}}">Overview</a>
												</li>
												<!--end::Nav item-->
												<!--begin::Nav item-->
												<li class="nav-item">
													<a class="nav-link text-active-primary me-6" href="{{route('admin.setting')}}">Settings</a>
												</li>
												<!--end::Nav item-->
											</ul>
										</div>
								...
								<div class="card mb-5 mb-xl-10" id="kt_profile_details_view">
									...
									<div class="card-header cursor-pointer">
										...
										<!--begin::Action-->
											...
											<a href="{{route('admin.setting')}}" class="btn btn-primary align-self-center">Edit Profile</a>
									...
									<div class="card-body p-9">
										...
										<div class="row mb-7">
											...
											<div class="col-lg-8 d-flex align-items-center">
												<span class="fw-bolder fs-6 me-2">{{$users->email}}</span>
										...
										<div class="row mb-7">
											...
											<!--begin::Col-->
											<div class="col-lg-8 d-flex align-items-center">
												<span class="fw-bolder fs-6 me-2">{{ $users->contact_number }}</span>
											</div>
											<!--end::Col-->
										</div>
										<!--end::Input group-->
										...
										<div class="card-body border-top p-9">
											...
											<div class="d-flex flex-wrap align-items-center">
												...
												<div id="kt_signin_email_edit" class="flex-row-fluid d-none">
													<!--begin::Form-->
													<form method="post" action="{{route('admin.change.email')}}" class="form" novalidate="novalidate">
														@csrf
														...
														<div class="row mb-6">
															<div class="col-lg-6 mb-4 mb-lg-0">
																<div class="fv-row mb-0">
																	...
																	<input type="email" class="form-control form-control-lg form-control-solid" placeholder="Email Address" name="email" value="{{ $users->email }}" />
																</div>
															</div>
														</div>
											...
											<div class="d-flex flex-wrap align-items-center mb-10">
												...
												<div id="kt_signin_password_edit" class="flex-row-fluid d-none">
													<!--begin::Form-->
													<form class="form" method="post" action="{{route('admin.change.password')}}" novalidate="novalidate">
														@csrf
