<!-- Modal -->
<div class="modal fade addHome" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel">Added Home Page</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>

            <form action="{{ route('admin.add.home.post') }}" method="post" id="add-home-form" enctype="multipart/form-data">
                @csrf
                    ...
                    <div class="modal-body py-10 px-lg-17">
                        ...
                        <div class="row col-md-12">
                            ...
                            <div class="col-md-6">
                                ...
                                <span class="text-danger error-text logo_name_error"></span>
                            </div>
                        </div>
