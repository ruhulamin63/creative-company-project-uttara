<!-- Modal -->
<div class="modal fade addCareer" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel">Added Job Context</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>

            <form action="{{ route('admin.add.career.post') }}" method="post" id="add-career-form">
                @csrf
                ...
                <div class="modal-body">
                    <div class="modal-body py-10 px-lg-17">
                        ...
                        <div class="col-md-12">
                            ...
                            <input type="number" class="form-control form-control-solid" name="vacancy" value=""/>
                            <span class="text-danger error-text vacancy_error"></span>
                        </div>
                        ...
                        <div class="col-md-12">
                            ...
                            <input type="number" class="form-control form-control-solid" name="salary_range" value=""/>
