<!-- Modal -->
<div class="modal fade editAbout" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <form action="<?= route('update.about.details') ?>" method="post" id="update-about-form" enctype="multipart/form-data">
            @csrf
