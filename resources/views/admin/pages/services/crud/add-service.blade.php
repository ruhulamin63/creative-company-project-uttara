...
<div class="modal fade addService" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="{{ route('admin.add.service.post') }}" method="post" id="add-service-form" enctype="multipart/form-data">
                @csrf
                            ...
                            <div class="col-lg-8">
                                ...
                                <div class="image-input image-input-outline" data-kt-image-input="true" style="background-image: url({{asset('media/avatars/blank.png')}})">
                                    ...
                                    <label class="btn btn-icon btn-circle btn-active-color-primary w-25px h-25px bg-white shadow" data-kt-image-input-action="change" data-bs-toggle="tooltip" title="Change avatar">
                                        ...
                                        <!--begin::Inputs-->
                                        <input type="file" name="service_image" accept=".png, .jpg, .jpeg" />
