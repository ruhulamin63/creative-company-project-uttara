								...
								<div class="card card-xxl-stretch mb-5 mb-xl-8">
									...
									<div class="card-header">
										<h3 class="card-title align-items-start flex-column">
											<span class="card-label fw-bolder fs-3 mb-1">Product List Information</span>
											<span class="text-muted mt-1 fw-bold fs-7">All Product list</span>
										</h3>
										<div class="card-toolbar">
											<button class="btn btn-sm btn-light-primary" id="addProductBtn"><i class="fas fa-plus"></i>Added Product</button>
										</div>
									</div>
									<!--end::Card header-->
											...
											<div class="card-body py-3">
												...
												<div class="card-body">
													<div class="table-responsive">
														<table class="table table-hover table-condensed" id="product-list-table">
															<thead>
